class Sensors:
    def __init__(self, IO):
        ...
        self.IO._interfaceKit.setSensorChangeTrigger(self.port["sonar"], 0)
    ...
    def get_whisker(self, side='both'):
        if side == 'both':
            return self.digital_readings[self.port['whisker']['left']] or self.digital_readings[
                self.port['whisker']['right']]
        else:
